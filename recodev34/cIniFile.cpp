...
void cIni::LoadSettings()
{
	...
	Ikaros.m_pCvars->BackgroundColorRed = ReadFloat("Settings", "colors.backgroundred", 0.0);
	Ikaros.m_pCvars->BackgroundColorGreen = ReadFloat("Settings", "colors.backgroundgreen", 0.0);
	Ikaros.m_pCvars->BackgroundColorBlue = ReadFloat("Settings", "colors.backgroundblue", 0);
	Ikaros.m_pCvars->BackgroundColorAlpha = ReadFloat("Settings", "colors.backgroundalpha", 125.0);

	Ikaros.m_pCvars->BorderColorRed = ReadFloat("Settings", "colors.borderred", 0.0);
	Ikaros.m_pCvars->BorderColorGreen = ReadFloat("Settings", "colors.bordergreen", 175.0);
	Ikaros.m_pCvars->BorderColorBlue = ReadFloat("Settings", "colors.borderblue", 255.0);
	Ikaros.m_pCvars->BorderColorAlpha = ReadFloat("Settings", "colors.borderalpha", 255.0);

	Ikaros.m_pCvars->DrawGroupBoxRed = ReadFloat("Settings", "colors.drawgroupboxred", 55.0);
	Ikaros.m_pCvars->DrawGroupBoxGreen = ReadFloat("Settings", "colors.drawgroupboxgreen", 55.0);
	Ikaros.m_pCvars->DrawGroupBoxBlue = ReadFloat("Settings", "colors.drawgroupboxblue", 55.0);
	Ikaros.m_pCvars->DrawGroupBoxAlpha = ReadFloat("Settings", "colors.drawgroupboxalpha", 255.0);

	Ikaros.m_pCvars->DrawComboBoxRed = ReadFloat("Settings", "colors.drawcomboboxred", 0.0);
	Ikaros.m_pCvars->DrawComboBoxGreen = ReadFloat("Settings", "colors.drawcomboboxgreen", 175.0);
	Ikaros.m_pCvars->DrawComboBoxBlue = ReadFloat("Settings", "colors.drawcomboboxblue", 255.0);
	Ikaros.m_pCvars->DrawComboBoxAlpha = ReadFloat("Settings", "colors.drawcomboboxalpha", 255.0);

	Ikaros.m_pCvars->ButtonsColorRed = ReadFloat("Settings", "colors.drawcheckboxred", 0.0);
	Ikaros.m_pCvars->ButtonsColorGreen = ReadFloat("Settings", "colors.drawcheckboxgreen", 175.0);
	Ikaros.m_pCvars->ButtonColorsBlue = ReadFloat("Settings", "colors.drawcheckboxblue", 255.0);
	Ikaros.m_pCvars->ButtonsColorsAlpha = ReadFloat("Settings", "colors.drawcheckalpha", 255.0);

	Ikaros.m_pCvars->ClickedButtonsRed = ReadFloat("Settings", "colors.cdrawcheckboxred", 0.0);
	Ikaros.m_pCvars->ClickedButtonsGreen = ReadFloat("Settings", "colors.cdrawcheckboxgreen", 255.0);
	Ikaros.m_pCvars->ClickedButtonsBlue = ReadFloat("Settings", "colors.cdrawcheckboxblue", 255.0);
	Ikaros.m_pCvars->ClickedButtonsAlpha = ReadFloat("Settings", "colors.cdrawcheckalpha", 255.0);

	Ikaros.m_pCvars->SliderColorRed = ReadFloat("Settings", "colors.sliderred", 0.0);
	Ikaros.m_pCvars->SliderColorGreen = ReadFloat("Settings", "colors.slidergreen", 175.0);
	Ikaros.m_pCvars->SliderColorBlue = ReadFloat("Settings", "colors.sliderblue", 255.0);
	Ikaros.m_pCvars->SliderColorAlpha = ReadFloat("Settings", "colors.slideralpha", 255.0);

	Ikaros.m_pCvars->TextColorRed = ReadFloat("Settings", "colors.textred", 255.0);
	Ikaros.m_pCvars->TextColorGreen = ReadFloat("Settings", "colors.textgreen", 255.0);
	Ikaros.m_pCvars->TextColorBlue = ReadFloat("Settings", "colors.textblue", 255.0);
	Ikaros.m_pCvars->TextColorAlpha = ReadFloat("Settings", "colors.textalpha", 255.0);

	Ikaros.m_pCvars->iButtonsMode = ReadInteger("Settings", "other.buttonsmode", 0);
}
...
void cIni::SaveSettings()
{
	...
	WriteFloat("Settings", "colors.backgroundred", Ikaros.m_pCvars->BackgroundColorRed);
	WriteFloat("Settings", "colors.backgroundgreen", Ikaros.m_pCvars->BackgroundColorGreen);
	WriteFloat("Settings", "colors.backgroundblue", Ikaros.m_pCvars->BackgroundColorBlue);
	WriteFloat("Settings", "colors.backgroundalpha", Ikaros.m_pCvars->BackgroundColorAlpha);

	WriteFloat("Settings", "colors.borderred", Ikaros.m_pCvars->BorderColorRed);
	WriteFloat("Settings", "colors.bordergreen", Ikaros.m_pCvars->BorderColorGreen);
	WriteFloat("Settings", "colors.borderblue", Ikaros.m_pCvars->BorderColorBlue);
	WriteFloat("Settings", "colors.borderalpha", Ikaros.m_pCvars->BorderColorAlpha);

	WriteFloat("Settings", "colors.drawgroupboxred", Ikaros.m_pCvars->DrawGroupBoxRed);
	WriteFloat("Settings", "colors.drawgroupboxgreen", Ikaros.m_pCvars->DrawGroupBoxGreen);
	WriteFloat("Settings", "colors.drawgroupboxblue", Ikaros.m_pCvars->DrawGroupBoxBlue);
	WriteFloat("Settings", "colors.drawgroupboxalpha", Ikaros.m_pCvars->DrawGroupBoxAlpha);

	WriteFloat("Settings", "colors.drawcomboboxred", Ikaros.m_pCvars->DrawComboBoxRed);
	WriteFloat("Settings", "colors.drawcomboboxgreen", Ikaros.m_pCvars->DrawComboBoxGreen);
	WriteFloat("Settings", "colors.drawcomboboxblue", Ikaros.m_pCvars->DrawComboBoxBlue);
	WriteFloat("Settings", "colors.drawcomboboxalpha", Ikaros.m_pCvars->DrawComboBoxAlpha);

	WriteFloat("Settings", "colors.drawcheckboxred", Ikaros.m_pCvars->ButtonsColorRed);
	WriteFloat("Settings", "colors.drawcheckboxgreen", Ikaros.m_pCvars->ButtonsColorGreen);
	WriteFloat("Settings", "colors.drawcheckboxblue", Ikaros.m_pCvars->ButtonColorsBlue);
	WriteFloat("Settings", "colors.drawcheckboxalpha", Ikaros.m_pCvars->ButtonsColorsAlpha);

	WriteFloat("Settings", "colors.cdrawcheckboxred", Ikaros.m_pCvars->ClickedButtonsRed);
	WriteFloat("Settings", "colors.cdrawcheckboxgreen", Ikaros.m_pCvars->ClickedButtonsGreen);
	WriteFloat("Settings", "colors.cdrawcheckboxblue", Ikaros.m_pCvars->ClickedButtonsBlue);
	WriteFloat("Settings", "colors.cdrawcheckboxalpha", Ikaros.m_pCvars->ClickedButtonsAlpha);

	WriteFloat("Settings", "colors.sliderred", Ikaros.m_pCvars->SliderColorRed);
	WriteFloat("Settings", "colors.slidergreen", Ikaros.m_pCvars->SliderColorGreen);
	WriteFloat("Settings", "colors.sliderblue", Ikaros.m_pCvars->SliderColorBlue);
	WriteFloat("Settings", "colors.slideralpha", Ikaros.m_pCvars->SliderColorAlpha);

	WriteFloat("Settings", "colors.textred", Ikaros.m_pCvars->TextColorRed);
	WriteFloat("Settings", "colors.textgreen", Ikaros.m_pCvars->TextColorGreen);
	WriteFloat("Settings", "colors.textblue", Ikaros.m_pCvars->TextColorBlue);
	WriteFloat("Settings", "colors.textalpha", Ikaros.m_pCvars->TextColorAlpha);

	WriteInteger("Settings", "other.buttonsmode", Ikaros.m_pCvars->iButtonsMode);
}