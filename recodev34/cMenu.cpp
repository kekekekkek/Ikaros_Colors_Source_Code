...
void CfgSelectButton(int x, int y)
{
	...
	{
		Ikaros.m_pDraw->FillRGBA(x, y, 45, 15, Ikaros.m_pCvars->ClickedButtonsRed, Ikaros.m_pCvars->ClickedButtonsGreen, Ikaros.m_pCvars->ClickedButtonsBlue, Ikaros.m_pCvars->ClickedButtonsAlpha);
	...
	{
		Ikaros.m_pDraw->FillRGBA(x, y, 45, 15, Ikaros.m_pCvars->ButtonsColorRed, Ikaros.m_pCvars->ButtonsColorGreen, Ikaros.m_pCvars->ButtonColorsBlue, Ikaros.m_pCvars->ButtonsColorsAlpha);
	}

	if (bIsRage)
	{
		Ikaros.m_pDraw->CenterText(x + 22, y - 1, Ikaros.m_pCvars->TextColorRed, Ikaros.m_pCvars->TextColorGreen, Ikaros.m_pCvars->TextColorBlue, Ikaros.m_pCvars->TextColorAlpha, "Rage");
	}
	else
	{
		Ikaros.m_pDraw->CenterText(x + 22, y - 1, Ikaros.m_pCvars->TextColorRed, Ikaros.m_pCvars->TextColorGreen, Ikaros.m_pCvars->TextColorBlue, Ikaros.m_pCvars->TextColorAlpha, "Legit");
	}
}
...
void SaveButton(int x, int y)
{
	...
	{
		Ikaros.m_pDraw->FillRGBA(x, y, 45, 15, Ikaros.m_pCvars->ClickedButtonsRed, Ikaros.m_pCvars->ClickedButtonsGreen, Ikaros.m_pCvars->ClickedButtonsBlue, Ikaros.m_pCvars->ClickedButtonsAlpha);
		Ikaros.m_pDraw->CenterText(x + 22, y - 1, Ikaros.m_pCvars->TextColorRed, Ikaros.m_pCvars->TextColorGreen, Ikaros.m_pCvars->TextColorBlue, Ikaros.m_pCvars->TextColorAlpha, "Save");
		if (Ikaros.m_pMouse->bMouse1released)
			bSave = true;
	}
	else
...
{
	Ikaros.m_pDraw->FillRGBA(x, y, w, h, Ikaros.m_pCvars->BackgroundColorRed, Ikaros.m_pCvars->BackgroundColorGreen, Ikaros.m_pCvars->BackgroundColorBlue, Ikaros.m_pCvars->BackgroundColorAlpha);//Background
	Ikaros.m_pDraw->Border(x, y, w, h, 6, Ikaros.m_pCvars->BorderColorRed, Ikaros.m_pCvars->BorderColorGreen, Ikaros.m_pCvars->BorderColorBlue, Ikaros.m_pCvars->BorderColorAlpha);//Border
	Ikaros.m_pDraw->FillRGBA(x, y, w, 25, Ikaros.m_pCvars->BorderColorRed, Ikaros.m_pCvars->BorderColorGreen, Ikaros.m_pCvars->BorderColorBlue, Ikaros.m_pCvars->BorderColorAlpha);//Topbar
	Ikaros.m_pDraw->Text(x + 6, y + 6, Ikaros.m_pCvars->TextColorRed, Ikaros.m_pCvars->TextColorGreen, Ikaros.m_pCvars->TextColorBlue, Ikaros.m_pCvars->TextColorAlpha, cName);//Name
...
{
	Ikaros.m_pDraw->FillRGBA(x, y, w, h, Ikaros.m_pCvars->DrawGroupBoxRed, Ikaros.m_pCvars->DrawGroupBoxGreen, Ikaros.m_pCvars->DrawGroupBoxBlue, Ikaros.m_pCvars->DrawGroupBoxAlpha);//Background
	Ikaros.m_pDraw->FillRGBA(x, y, w, 20, Ikaros.m_pCvars->BorderColorRed, Ikaros.m_pCvars->BorderColorGreen, Ikaros.m_pCvars->BorderColorBlue, Ikaros.m_pCvars->BorderColorAlpha);//Topbar
	Ikaros.m_pDraw->Text(x + 3, y + 4, Ikaros.m_pCvars->TextColorRed, Ikaros.m_pCvars->TextColorGreen, Ikaros.m_pCvars->TextColorBlue, Ikaros.m_pCvars->TextColorAlpha, Name);
}
...
void CMenu::DrawComboBox(int x, int y, char* Name, int &Selection, int num, int max, char** structs, char* Description)
{
	...
	Ikaros.m_pDraw->FillRGBA(x + 2, y - 3, 85, 2, Ikaros.m_pCvars->DrawComboBoxRed, Ikaros.m_pCvars->DrawComboBoxGreen, Ikaros.m_pCvars->DrawComboBoxBlue, Ikaros.m_pCvars->DrawGroupBoxAlpha);//Top
	Ikaros.m_pDraw->FillRGBA(x + 2, y - 3, 2, 22, Ikaros.m_pCvars->DrawComboBoxRed, Ikaros.m_pCvars->DrawComboBoxGreen, Ikaros.m_pCvars->DrawComboBoxBlue, Ikaros.m_pCvars->DrawGroupBoxAlpha);//Left
	Ikaros.m_pDraw->FillRGBA(x + 87, y - 3, 2, 22, Ikaros.m_pCvars->DrawComboBoxRed, Ikaros.m_pCvars->DrawComboBoxGreen, Ikaros.m_pCvars->DrawComboBoxBlue, Ikaros.m_pCvars->DrawGroupBoxAlpha);//Right
	if (cComboBox[num].Active)
	{
		...
		Ikaros.m_pDraw->FillRGBA(x + 2, y + 17, 85, 2, Ikaros.m_pCvars->DrawComboBoxRed, Ikaros.m_pCvars->DrawComboBoxGreen, Ikaros.m_pCvars->DrawComboBoxBlue, Ikaros.m_pCvars->DrawGroupBoxAlpha);//Bottom
		Ikaros.m_pDraw->Text(x + 8, y + 1, Ikaros.m_pCvars->TextColorRed, Ikaros.m_pCvars->TextColorGreen, Ikaros.m_pCvars->TextColorBlue, Ikaros.m_pCvars->TextColorAlpha, cComboBox[num].Name);
	...
	else
	{
		if (cComboBox[num].Open)
		{
			...
			for (int i = 0; i < max; i++)
			{
				...
				Ikaros.m_pDraw->FillRGBA(x + 2, y - 1 + (i * 20), 2, 24, Ikaros.m_pCvars->DrawComboBoxRed, Ikaros.m_pCvars->DrawComboBoxGreen, Ikaros.m_pCvars->DrawComboBoxBlue, Ikaros.m_pCvars->DrawGroupBoxAlpha);//Left * count
				Ikaros.m_pDraw->FillRGBA(x + 87, y - 1 + (i * 20), 2, 24, Ikaros.m_pCvars->DrawComboBoxRed, Ikaros.m_pCvars->DrawComboBoxGreen, Ikaros.m_pCvars->DrawComboBoxBlue, Ikaros.m_pCvars->DrawGroupBoxAlpha);//Right * count
				if (Ikaros.m_pMouse->IsInBox(x + 6, y + 1 + (i * 20), 79, 20))
				{
					Ikaros.m_pDraw->FillRGBA(x + 6, y + 1 + (i * 20), 79, 20, Ikaros.m_pCvars->DrawComboBoxRed, Ikaros.m_pCvars->DrawComboBoxGreen, Ikaros.m_pCvars->DrawComboBoxBlue, Ikaros.m_pCvars->DrawGroupBoxAlpha);//highlight selection
					if (Ikaros.m_pMouse->bMouse1released)
					{
				...
				Ikaros.m_pDraw->Text(x + 8, y + 3 + (i * 20), Ikaros.m_pCvars->TextColorRed, Ikaros.m_pCvars->TextColorGreen, Ikaros.m_pCvars->TextColorBlue, Ikaros.m_pCvars->TextColorAlpha, structs[i]);//List struct
			}
			Ikaros.m_pDraw->FillRGBA(x + 2, y + 3 + (max * 20), 87, 2, Ikaros.m_pCvars->DrawComboBoxRed, Ikaros.m_pCvars->DrawComboBoxGreen, Ikaros.m_pCvars->DrawComboBoxBlue, Ikaros.m_pCvars->DrawGroupBoxAlpha);//Bottom
		}
	}

	Ikaros.m_pDraw->Text(x + 92, y + 1, Ikaros.m_pCvars->TextColorRed, Ikaros.m_pCvars->TextColorGreen, Ikaros.m_pCvars->TextColorBlue, Ikaros.m_pCvars->TextColorAlpha, Name);
}
...
void CMenu::DrawCheckBox(int x, int y, const char* szString, bool &toggle, char* Description)
{
	...
	{
		Ikaros.m_pDraw->Border(x + 2, y - 3, 13, 13, 1, Ikaros.m_pCvars->ButtonsColorRed, Ikaros.m_pCvars->ButtonsColorGreen, Ikaros.m_pCvars->ButtonColorsBlue, Ikaros.m_pCvars->ButtonsColorsAlpha);
		DrawInfo(Description);
	}
	...
	if (toggle)
	{
		if (Ikaros.m_pCvars->iButtonsMode == 0)
		{
			Ikaros.m_pDraw->FillRGBA(x + 4, y - 1, 10, 10, Ikaros.m_pCvars->ButtonsColorRed, Ikaros.m_pCvars->ButtonsColorGreen, Ikaros.m_pCvars->ButtonColorsBlue, Ikaros.m_pCvars->ButtonsColorsAlpha);
		}
		else if (Ikaros.m_pCvars->iButtonsMode == 1)
		{
			Ikaros.m_pDraw->Text(x + 6, y - 4, Ikaros.m_pCvars->ButtonsColorRed, Ikaros.m_pCvars->ButtonsColorGreen, Ikaros.m_pCvars->ButtonColorsBlue, Ikaros.m_pCvars->ButtonsColorsAlpha, "+");
		}
		if (Ikaros.m_pCvars->iButtonsMode == 2)
		{
			Ikaros.m_pDraw->Text(x + 6, y - 3, Ikaros.m_pCvars->ButtonsColorRed, Ikaros.m_pCvars->ButtonsColorGreen, Ikaros.m_pCvars->ButtonColorsBlue, Ikaros.m_pCvars->ButtonsColorsAlpha, "X");
		}
	}
	Ikaros.m_pDraw->Text(x + 20, y - 2, Ikaros.m_pCvars->TextColorRed, Ikaros.m_pCvars->TextColorGreen, Ikaros.m_pCvars->TextColorBlue, Ikaros.m_pCvars->TextColorAlpha, szString);
}

void CMenu::DrawTabs(const char* Name, int tab, int x, int y)
{
	Ikaros.m_pDraw->FillRGBA(x, y, 150, 45, Ikaros.m_pCvars->DrawGroupBoxRed, Ikaros.m_pCvars->DrawGroupBoxGreen, Ikaros.m_pCvars->DrawGroupBoxBlue, Ikaros.m_pCvars->DrawGroupBoxAlpha);
	...
	Ikaros.m_pDraw->Text(x + 25, y + 14, Ikaros.m_pCvars->TextColorRed, Ikaros.m_pCvars->TextColorGreen, Ikaros.m_pCvars->TextColorBlue, Ikaros.m_pCvars->TextColorAlpha, Name);
}
...
void CMenu::MenuDrawTabs(const char* Name, int tab, int x, int y)
{
	...
	Ikaros.m_pDraw->Text(x + 20, y + 15, Ikaros.m_pCvars->TextColorRed, Ikaros.m_pCvars->TextColorGreen, Ikaros.m_pCvars->TextColorBlue, Ikaros.m_pCvars->TextColorAlpha, Name);
}
...
void CMenu::Slider(int x, int y, bool bInt, float &iInput, float iMin, float iMax, char* Name, char* Description)
{
	...
	Ikaros.m_pDraw->FillRGBA(x + 1, y + 6, barpos, 3, Ikaros.m_pCvars->SliderColorRed, Ikaros.m_pCvars->SliderColorGreen, Ikaros.m_pCvars->SliderColorBlue, Ikaros.m_pCvars->SliderColorAlpha);

	Ikaros.m_pDraw->FillRGBA(x + barpos - 2, y + 3, 5, 9, Ikaros.m_pCvars->SliderColorRed, Ikaros.m_pCvars->SliderColorGreen, Ikaros.m_pCvars->SliderColorBlue, Ikaros.m_pCvars->SliderColorAlpha);

	Ikaros.m_pDraw->Text(x + 208, y, Ikaros.m_pCvars->TextColorRed, Ikaros.m_pCvars->TextColorGreen, Ikaros.m_pCvars->TextColorBlue, Ikaros.m_pCvars->TextColorAlpha, "%s: %0.1f", Name, iInput);
}

void CMenu::Slider2(int x, int y, int red, int green, int blue, int alpha, bool bInt, float &iInput, float iMin, float iMax, char* Name, char* Description)
{
	float sliderpos, barpos;
	...
	Ikaros.m_pDraw->FillRGBA(x + 1, y + 6, barpos, 3, red, green, blue, alpha);

	Ikaros.m_pDraw->FillRGBA(x + barpos - 2, y + 3, 5, 9, red, green, blue, alpha);

	Ikaros.m_pDraw->Text(x + 40, y - 13, Ikaros.m_pCvars->TextColorRed, Ikaros.m_pCvars->TextColorGreen, Ikaros.m_pCvars->TextColorBlue, Ikaros.m_pCvars->TextColorAlpha, "%s: %0.1f", Name, iInput);
}
...
void DrawMonitorBar(int x, int y, int cur, const char* title)
{
	...
	Ikaros.m_pDraw->Text(x, y + 169, Ikaros.m_pCvars->TextColorRed, Ikaros.m_pCvars->TextColorGreen, Ikaros.m_pCvars->TextColorBlue, Ikaros.m_pCvars->TextColorAlpha, title);
}
		...
		for (int index = 0; index < Ikaros.m_pGlobals->maxClients; index++)
		{
			...
			if (Ikaros.m_pEngine->GetPlayerInfo(index, &pInfo))
			{
				...
				if (Ikaros.m_pCvars->bShowGUI && Ikaros.m_pCvars->bPlayerList)
				{
					...
					{
						Ikaros.m_pDraw->FillRGBA(x1, y1 + 16 + ((in)* 13), 625, 12, Ikaros.m_pCvars->ButtonsColorRed, Ikaros.m_pCvars->ButtonsColorGreen, Ikaros.m_pCvars->ButtonColorsBlue, Ikaros.m_pCvars->ButtonsColorsAlpha);//highlight selection
					...
					Ikaros.m_pDraw->Text(x1 + 10, y1 + 15 + ((in)* 13), Ikaros.m_pCvars->TextColorRed, Ikaros.m_pCvars->TextColorGreen, Ikaros.m_pCvars->TextColorBlue, Ikaros.m_pCvars->TextColorAlpha, "%s: %s", pInfo.name, pInfo.guid);
				}
				in++;
			}
		}
...
{
	//Main Window
	DrawWindow(x, y, 800, 475, "Shit niggaaaaaaas");
	...
	DrawTabs("Colors", 9, x + 6, y + 386);
	//Config Zone
	Ikaros.m_pDraw->FillRGBA(x + 6, y + 430, 150, 45, Ikaros.m_pCvars->DrawGroupBoxRed, Ikaros.m_pCvars->DrawGroupBoxGreen, Ikaros.m_pCvars->DrawGroupBoxBlue, Ikaros.m_pCvars->DrawGroupBoxAlpha);
	CfgSelectButton(x + 20, y + 445);
	SaveButton(x + 90, y + 445);

	Ikaros.m_pDraw->FillRGBA(x + 160, y + 435, 635, 35, Ikaros.m_pCvars->DrawGroupBoxRed, Ikaros.m_pCvars->DrawGroupBoxGreen, Ikaros.m_pCvars->DrawGroupBoxBlue, Ikaros.m_pCvars->DrawGroupBoxAlpha);

	if (openTab.ActiveTab == tab1)
	{
		Ikaros.m_pCvars->bPlayerList = false;
		Ikaros.m_pDraw->FillRGBA(x + 141, y + 31, 10, 35, Ikaros.m_pCvars->ButtonsColorRed, Ikaros.m_pCvars->ButtonsColorGreen, Ikaros.m_pCvars->ButtonColorsBlue, Ikaros.m_pCvars->ButtonsColorsAlpha);
	...
	{
		Ikaros.m_pCvars->bPlayerList = false;
		Ikaros.m_pDraw->FillRGBA(x + 141, y + 76, 10, 35, Ikaros.m_pCvars->ButtonsColorRed, Ikaros.m_pCvars->ButtonsColorGreen, Ikaros.m_pCvars->ButtonColorsBlue, Ikaros.m_pCvars->ButtonsColorsAlpha);
		DrawGroupBox(x + 160, y + 30, 315, 400, "");
	...
	{
		Ikaros.m_pCvars->bPlayerList = false;
		Ikaros.m_pDraw->FillRGBA(x + 141, y + 121, 10, 35, Ikaros.m_pCvars->ButtonsColorRed, Ikaros.m_pCvars->ButtonsColorGreen, Ikaros.m_pCvars->ButtonColorsBlue, Ikaros.m_pCvars->ButtonsColorsAlpha);
		DrawGroupBox(x + 160, y + 30, 315, 400, "");
	...
	{
		Ikaros.m_pCvars->bPlayerList = false;
		Ikaros.m_pDraw->FillRGBA(x + 141, y + 166, 10, 35, Ikaros.m_pCvars->ButtonsColorRed, Ikaros.m_pCvars->ButtonsColorGreen, Ikaros.m_pCvars->ButtonColorsBlue, Ikaros.m_pCvars->ButtonsColorsAlpha);
	...
	{
		Ikaros.m_pCvars->bPlayerList = false;
		Ikaros.m_pDraw->FillRGBA(x + 141, y + 211, 10, 35, Ikaros.m_pCvars->ButtonsColorRed, Ikaros.m_pCvars->ButtonsColorGreen, Ikaros.m_pCvars->ButtonColorsBlue, Ikaros.m_pCvars->ButtonsColorsAlpha);
		DrawGroupBox(x + 160, y + 30, 635, 400, "");
	...
	{
		Ikaros.m_pCvars->bPlayerList = false;
		Ikaros.m_pDraw->FillRGBA(x + 141, y + 256, 10, 35, Ikaros.m_pCvars->ButtonsColorRed, Ikaros.m_pCvars->ButtonsColorGreen, Ikaros.m_pCvars->ButtonColorsBlue, Ikaros.m_pCvars->ButtonsColorsAlpha);
		DrawGroupBox(x + 160, y + 30, 635, 400, "");
	...
	{
		Ikaros.m_pCvars->bPlayerList = false;
		Ikaros.m_pDraw->FillRGBA(x + 141, y + 301, 10, 35, Ikaros.m_pCvars->ButtonsColorRed, Ikaros.m_pCvars->ButtonsColorGreen, Ikaros.m_pCvars->ButtonColorsBlue, Ikaros.m_pCvars->ButtonsColorsAlpha);
		DrawGroupBox(x + 160, y + 30, 635, 400, "");
	...
	else if (openTab.ActiveTab == tab8)
	{
		int x1 = x + 165;
		int y1 = y + 35;
		Ikaros.m_pDraw->FillRGBA(x + 141, y + 346, 10, 35, Ikaros.m_pCvars->ButtonsColorRed, Ikaros.m_pCvars->ButtonsColorGreen, Ikaros.m_pCvars->ButtonColorsBlue, Ikaros.m_pCvars->ButtonsColorsAlpha);
		...
		if (iSel > 0)
		{
			Ikaros.m_pDraw->FillRGBA(x1, y1 + 16 + (iSel * 13), 625, 12, Ikaros.m_pCvars->ButtonsColorRed, Ikaros.m_pCvars->ButtonsColorGreen, Ikaros.m_pCvars->ButtonColorsBlue, Ikaros.m_pCvars->ButtonsColorsAlpha);//highlight selection
		}
	}
	else if (openTab.ActiveTab == tab9)
	{
	    ...
	    int h = 0;
		Ikaros.m_pCvars->bPlayerList = false;
		Ikaros.m_pDraw->FillRGBA(x + 141, y + 391, 10, 35, Ikaros.m_pCvars->ButtonsColorRed, Ikaros.m_pCvars->ButtonsColorGreen, Ikaros.m_pCvars->ButtonColorsBlue, Ikaros.m_pCvars->ButtonsColorsAlpha);
		DrawGroupBox(x + 160, y + 30, 635, 400, "");
		Ikaros.m_pDraw->Border(x + 694, y + 69, w + 72, h + 52, 1, 255, 255, 0, 255);//Page1
		Ikaros.m_pDraw->Border(x + 694, y + 124, w + 72, h + 52, 1, 0, 255, 0, 255);//Page2
		Ikaros.m_pDraw->Border(x + 694, y + 179, w + 72, h + 52, 1, 0, 255, 0, 255);//Page2
		MenuDrawTabs("Page1", 9, x + 695, y + 70);
		MenuDrawTabs("Page2", 10, x + 695, y + 125);
		MenuDrawTabs("Other", 11, x + 695, y + 180);
		//background
		Slider2(x + 165, y + 70, 255, 0, 0, 255, 0, Ikaros.m_pCvars->BackgroundColorRed, 0.f, 255.f, "BackGroundColor Red", "");
		Slider2(x + 165, y + 100, 0, 255, 0, 255, 0, Ikaros.m_pCvars->BackgroundColorGreen, 0.f, 255.f, "BackGroundColor Green", "");
		Slider2(x + 165, y + 130, 0, 0, 255, 255, 0, Ikaros.m_pCvars->BackgroundColorBlue, 0.f, 255.f, "BackGroundColor Blue", "");
		Slider2(x + 165, y + 160, 125, 125, 125, 255, 0, Ikaros.m_pCvars->BackgroundColorAlpha, 0.f, 255.f, "BackGroundColor Alpha", "");
		//border
		Slider2(x + 165, y + 190, 255, 0, 0, 255, 0, Ikaros.m_pCvars->BorderColorRed, 0.f, 255.f, "BorderColor Red", "");
		Slider2(x + 165, y + 220, 0, 255, 0, 255, 0, Ikaros.m_pCvars->BorderColorBlue, 0.f, 255.f, "BorderColor Green", "");
		Slider2(x + 165, y + 250, 0, 0, 255, 255, 0, Ikaros.m_pCvars->BorderColorGreen, 0.f, 255.f, "BorderColor Blue", "");
		Slider2(x + 165, y + 280, 125, 125, 125, 255, 0, Ikaros.m_pCvars->BorderColorAlpha, 0.f, 255.f, "BorderColor Alpha", "");
		//drawgroupbox
		Slider2(x + 165, y + 310, 255, 0, 0, 255, 0, Ikaros.m_pCvars->DrawGroupBoxRed, 0.f, 255.f, "DrawGroupBox Red", "");
		Slider2(x + 165, y + 340, 0, 255, 0, 255, 0, Ikaros.m_pCvars->DrawGroupBoxGreen, 0.f, 255.f, "DrawGroupBox Green", "");
		Slider2(x + 165, y + 370, 0, 0, 255, 255, 0, Ikaros.m_pCvars->DrawGroupBoxBlue, 0.f, 255.f, "DrawGroupBox Blue", "");
		Slider2(x + 165, y + 400, 125, 125, 125, 255, 0, Ikaros.m_pCvars->DrawGroupBoxAlpha, 0.f, 255.f, "DrawGroupBox Alpha", "");
		//drawcombobox
		Slider2(x + 475, y + 70, 255, 0, 0, 255, 0, Ikaros.m_pCvars->DrawComboBoxRed, 0.f, 255.f, "DrawComboBox Red", "");
		Slider2(x + 475, y + 100, 0, 255, 0, 255, 0, Ikaros.m_pCvars->DrawComboBoxGreen, 0.f, 255.f, "DrawComboBox Green", "");
		Slider2(x + 475, y + 130, 0, 0, 255, 255, 0, Ikaros.m_pCvars->DrawComboBoxBlue, 0.f, 255.f, "DrawComboBox Blue", "");
		Slider2(x + 475, y + 160, 125, 125, 125, 125, 0, Ikaros.m_pCvars->DrawComboBoxAlpha, 0.f, 255.f, "DrawComboBox Alpha", "");
		//drawcheckbox
		Slider2(x + 475, y + 190, 255, 0, 0, 255, 0, Ikaros.m_pCvars->ButtonsColorRed, 0.f, 255.f, "ButtonsColorRed Red", "");
		Slider2(x + 475, y + 220, 0, 255, 0, 255, 0, Ikaros.m_pCvars->ButtonsColorGreen, 0.f, 255.f, "ButtonsColorGreen Green", "");
		Slider2(x + 475, y + 250, 0, 0, 255, 255, 0, Ikaros.m_pCvars->ButtonColorsBlue, 0.f, 255.f, "ButtonsColorBlue Blue", "");
		Slider2(x + 475, y + 280, 125, 125, 125, 255, 0, Ikaros.m_pCvars->ButtonsColorsAlpha, 0.f, 255.f, "ButtonColorAlpha Alpha", "");
		//clickedbuttonscolor
		Slider2(x + 475, y + 310, 255, 0, 0, 255, 0, Ikaros.m_pCvars->ClickedButtonsRed, 0.f, 255.f, "ClickedButtonsColor Red", "");
		Slider2(x + 475, y + 340, 0, 255, 0, 255, 0, Ikaros.m_pCvars->ClickedButtonsGreen, 0.f, 255.f, "ClickedButtonsColor Green", "");
		Slider2(x + 475, y + 370, 0, 0, 255, 255, 0, Ikaros.m_pCvars->ClickedButtonsBlue, 0.f, 255.f, "ClickedButtonsColor Blue", "");
		Slider2(x + 475, y + 400, 125, 125, 125, 255, 0, Ikaros.m_pCvars->ClickedButtonsAlpha, 0.f, 255.f, "ClickedButtonsColor Alpha", "");
	}
	else if (openTab.ActiveTab == tab10)
	{
	    int w = 0;
	    int h = 0;
		Ikaros.m_pCvars->bPlayerList = false;
		Ikaros.m_pDraw->FillRGBA(x + 141, y + 391, 10, 35, Ikaros.m_pCvars->ButtonsColorRed, Ikaros.m_pCvars->ButtonsColorGreen, Ikaros.m_pCvars->ButtonColorsBlue, Ikaros.m_pCvars->ButtonsColorsAlpha);
		DrawGroupBox(x + 160, y + 30, 635, 400, "");
		Ikaros.m_pDraw->Border(x + 694, y + 69, w + 72, h + 52, 1, 0, 255, 0, 255);//Page1
		Ikaros.m_pDraw->Border(x + 694, y + 124, w + 72, h + 52, 1, 255, 255, 0, 255);//Page2
		Ikaros.m_pDraw->Border(x + 694, y + 179, w + 72, h + 52, 1, 0, 255, 0, 255);//Other
		MenuDrawTabs("Page1", 9, x + 695, y + 70);
		MenuDrawTabs("Page2", 10, x + 695, y + 125);
		MenuDrawTabs("Other", 11, x + 695, y + 180);
		//slider
		Slider2(x + 165, y + 70, 255, 0, 0, 255, 0, Ikaros.m_pCvars->SliderColorRed, 0.f, 255.f, "SliderColor Red", "");
		Slider2(x + 165, y + 100, 0, 255, 0, 255, 0, Ikaros.m_pCvars->SliderColorGreen, 0.f, 255.f, "Slider Green", "");
		Slider2(x + 165, y + 130, 0, 0, 255, 255, 0, Ikaros.m_pCvars->SliderColorBlue, 0.f, 255.f, "Slider Blue", "");
		Slider2(x + 165, y + 160, 125, 125, 125, 255, 0, Ikaros.m_pCvars->SliderColorAlpha, 0.f, 255.f, "Slider Alpha", "");
		//text
		Slider2(x + 165, y + 190, 255, 0, 0, 255, 0, Ikaros.m_pCvars->TextColorRed, 0.f, 255.f, "TextColor Red", "");
		Slider2(x + 165, y + 220, 0, 255, 0, 255, 0, Ikaros.m_pCvars->TextColorGreen, 0.f, 255.f, "TextColor Green", "");
		Slider2(x + 165, y + 250, 0, 0, 255, 255, 0, Ikaros.m_pCvars->TextColorBlue, 0.f, 255.f, "TextColor Blue", "");
		Slider2(x + 165, y + 280, 125, 125, 125, 255, 0, Ikaros.m_pCvars->TextColorAlpha, 0.f, 255.f, "TextColor Alpha", "");
	}
	else if (openTab.ActiveTab == tab11)
	{
		int w = 0;
		int h = 0;
		Ikaros.m_pCvars->bPlayerList = false;
		...
		Ikaros.m_pDraw->Border(x + 694, y + 69, w + 72, h + 52, 1, 0, 255, 0, 255);//Page1
		Ikaros.m_pDraw->Border(x + 694, y + 124, w + 72, h + 52, 1, 0, 255, 0, 255);//Page2
		Ikaros.m_pDraw->Border(x + 694, y + 179, w + 72, h + 52, 1, 255, 255, 0, 255);//Other
		MenuDrawTabs("Page1", 9, x + 695, y + 70);
		MenuDrawTabs("Page2", 10, x + 695, y + 125);
		MenuDrawTabs("Other", 11, x + 695, y + 180);
		DrawComboBox(x + 165, y + 60, "ButtonsMode", Ikaros.m_pCvars->iButtonsMode, 9, 3, ButtonsMode, "");
	}
}
...
void CMenu::DrawMenu()
{
	...
	if (!Ikaros.m_pCvars->bPanicKey)
	{
		...
		if (Ikaros.m_pCvars->bWatermark)
			Ikaros.m_pDraw->Text(2, 2, 255, 255, 255, 255, "nigga hack xd"); 
