...
void SetConsoleColor(int textcolor1, int textcolor2, int textcolor3)
{
	HANDLE output = GetStdHandle(STD_OUTPUT_HANDLE);
	SetConsoleTextAttribute(GetStdHandle(STD_OUTPUT_HANDLE), textcolor1 | textcolor2 | textcolor3);
}
//=============================================================================
void CreateConsole()
{
...
BOOL WINAPI DllMain(HMODULE hModule, DWORD dwReason, LPVOID lpvReserved)
{
	if (dwReason == DLL_PROCESS_ATTACH)
	{
		...
		SetConsoleColor(FOREGROUND_GREEN, FOREGROUND_GREEN, FOREGROUND_INTENSITY);
		speak("-----------------------------------------------------------");
