...
public: 
	...
	int iSavedRadarX, iSavedRadarY, iCrosshair, iMenuX, iMenuY, iMonitorPosX, iMonitorPosY, iMonitorSavePosX, iMonitorSavePosY, iButtonsMode;
	...
	float BackgroundColorRed, BackgroundColorGreen, BackgroundColorBlue, BackgroundColorAlpha, BorderColorRed, BorderColorGreen, BorderColorBlue, BorderColorAlpha, DrawGroupBoxRed, DrawGroupBoxGreen, DrawGroupBoxBlue, DrawGroupBoxAlpha, DrawComboBoxRed, DrawComboBoxGreen, DrawComboBoxBlue, DrawComboBoxAlpha, ButtonsColorRed, ButtonsColorGreen, ButtonColorsBlue, ButtonsColorsAlpha, ClickedButtonsRed, ClickedButtonsGreen, ClickedButtonsBlue, ClickedButtonsAlpha, SliderColorRed, SliderColorGreen, SliderColorBlue, SliderColorAlpha, TextColorRed, TextColorGreen, TextColorBlue, TextColorAlpha;
};
